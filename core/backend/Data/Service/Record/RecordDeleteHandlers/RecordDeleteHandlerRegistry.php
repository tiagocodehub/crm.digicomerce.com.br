...
class RecordDeleteHandlerRegistry implements RecordDeleteHandlerRegistryInterface
{
    use RecordDeleteHandlerTrait;

    /**
     * @var RecordDeleteHandlerInterface[]
     */
    protected array $registry = [];

    /**
     * RecordDeleteHandlerRegistry constructor.
     * @param Traversable $handlers
     */
    public function __construct(Traversable $handlers)
    {
        /** @var RecordDeleteHandlerInterface[] $handlersArray */
        $handlersArray = [];
     ...
     * @return RecordDeleteHandlerInterface[]
     */
    ...
    /**
     * @param RecordDeleteHandlerInterface[] $handlers
     * @return void
     */
