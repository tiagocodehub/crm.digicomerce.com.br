...
class DisableDuplicationAttachmentsVardefMapper implements VardefConfigMapperInterface
{
    /**
     * @inheritDoc
     */
    ...
    {
        return 'disable-duplication-attachment-field';
    }
    ...
    public function map(array $vardefs): array
    {
        ...
        foreach ($vardefs as $index => $vardef) {
            ...
            if ($vardef['type'] === 'attachment' && !isset($metadata['allow_duplicate'])) {
