...
class RecordFieldTypeDeleteHandlerRegistry
{
    use RecordFieldDeleteHandlerTrait;

    /**
     * @var RecordFieldTypeDeleteHandlerInterface[]
     */
    ...
    /**
     * RecordFieldTypeDeleteHandlerRegistry constructor.
     * @param Traversable $handlers
     */
    public function __construct(Traversable $handlers)
    {
        /** @var RecordFieldTypeDeleteHandlerInterface[] $handlersArray */
        $handlersArray = [];
    ...
    /**
     * Get the field type delete handlers for the module, type and mode
     * @param string $module
     * @param string $fieldType
     * @param string|null $mode
     * @return RecordFieldTypeDeleteHandlerInterface[]
     */
     ...
     * @param string $fieldType
     * @param string $mode
     * @return RecordFieldTypeDeleteHandlerInterface|null
     */
    public function getDefaultHandler(string $module, string $fieldType, string $mode): ?RecordFieldTypeDeleteHandlerInterface
    {
    ...
    /**
     * @param RecordFieldTypeDeleteHandlerInterface[] $handlers
     * @return void
     */
