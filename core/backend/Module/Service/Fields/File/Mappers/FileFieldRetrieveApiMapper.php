 ...
 */
namespace App\Module\Service\Fields\File\Mappers;
...
class FileFieldRetrieveApiMapper implements ApiRecordFieldTypeMapperInterface
{
    use FileFieldApiMapperTrait;
    ...
    {
        $fieldDefs = $fieldDefinitions->getVardef()[$field] ?? [];

        $storageType = $fieldDefs['metadata']['storage_type'] ?? '';
