...
namespace App\Module\Service\Fields\LineItems\SaveHandlers;
...
class LineItemsSaveHandler implements RecordFieldTypeSaveHandlerInterface
{
    ...
    public function run(?Record $previousVersion, Record $inputRecord, ?Record $savedRecord, FieldDefinition $fieldDefinition, string $field): void
    {
        ...
        $this->linkedRecordsProvider->syncRelatedRecords($savedRecord, $relatedRecords, $linkField);
    }
