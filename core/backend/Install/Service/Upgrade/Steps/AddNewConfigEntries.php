...
use App\Install\LegacyHandler\Upgrade\AddNewConfigEntriesHandler;
use App\Install\Service\Upgrade\UpgradeStepInterface;
use Exception;

/**
 * Class AddNewConfigEntries
 * @package App\Install\Service\Upgrade\Steps;
 */
class AddNewConfigEntries implements UpgradeStepInterface
{
    use ProcessStepTrait;

    public const HANDLER_KEY = 'add-new-config-entries';
    public const POSITION = 750;
    public const STAGE = 'upgrade-finalize';

    /**
     * @var AddNewConfigEntriesHandler
     */
    private $handler;

    /**
     * AddNewConfigEntries constructor.
     * @param AddNewConfigEntriesHandler $handler
     */
    public function __construct(AddNewConfigEntriesHandler $handler)
    {
