...
class CheckIdSuppressionList extends BaseEmailTargetValidator
{
    ...
    public function validate(
        ...
        $onSuppressionList = $this->suppressionListManager->isOnIdSuppressionList(
            $campaignId,
