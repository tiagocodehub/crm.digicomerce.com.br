...
trait RecordFieldDeleteHandlerTrait
{
    use ModuleDeleteHandlerTrait;

    /**
     * @param array $moduleHandlers
     * @param string $key
     * @param int $order
     * @param BaseModuleDeleteHandlerInterface $handler
     */
    protected function addHandler(array &$moduleHandlers, string $key, int $order, BaseModuleDeleteHandlerInterface $handler): void
    {
    ...
    /**
     * @param BaseModuleDeleteHandlerInterface[] $registry
     * @param string $module
     * @param string $key
     * @return array
     */
     ...
     * @param string $module
     * @param string $key
     * @return BaseModuleDeleteHandlerInterface[]
     */
