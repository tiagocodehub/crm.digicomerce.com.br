...
class MassUpdateActionChecker implements ActionAvailabilityCheckerInterface
{
    /**
     * @var MassUpdateDefinitionProviderInterface
     */
    private $massUpdateDefinitions;

    /**
     * MassUpdateActionChecker constructor.
     * @param MassUpdateDefinitionProviderInterface $massUpdateDefinitions
     */
    public function __construct(MassUpdateDefinitionProviderInterface $massUpdateDefinitions)
    {
        $this->massUpdateDefinitions = $massUpdateDefinitions;
    }
    ...
    public function checkAvailability(string $module, ?array $entry = [], ?array $context = []): bool
    {
        ...
        return !empty($definitions['fields']);
    }
}
