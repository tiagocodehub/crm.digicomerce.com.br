...
class CheckEmailAddressSuppressionList extends BaseEmailTargetValidator
{
    ...
    {
        return 'suppressed-by-email-list';
    }
    ...
    public function validate(
        ...
        $onSuppressionList = $this->suppressionListManager->isOnEmailAddressSuppressionList(
            $campaignId,
